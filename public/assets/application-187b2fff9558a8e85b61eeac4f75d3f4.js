...
(function() {
  ...
  this.tdlist.controller('CreateCtrl', function($scope, $rootScope, $http, $location) {
    var HOME_PATH;
    HOME_PATH = '/';
    $scope.save = function() {
      var params;
      ...
      return $http.post('/messages', params).success(success($location, HOME_PATH)).error(error);
    };
    return $scope.update = function() {
      ...
      $http.put('/messages/' + params.id, params).success(success($location, HOME_PATH)).error(error);
...
(function() {
  ...
  this.tdlist.controller('IndexCtrl', function($scope, $rootScope, $http, $location) {
    var source;
    ...
    $scope.destroy = function(id) {
      var redirect;
      redirect = '/ok';
      return $http["delete"]('/messages/' + id).success(success($location, redirect)).error(error);
    };
    return $scope.update = function(message) {
